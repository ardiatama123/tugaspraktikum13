...
while($row = mysqli_fetch_array($negara)){
	...
	$query = mysqli_query($koneksi,"select new_case from tb_allcase where id_negara ='".$row['id_negara']."'");
	$row = $query->fetch_array();
	$total_case[] = $row['new_case'];
}
?>
<!doctype html>
<html>
...
<head>
	<title>Pie Chart New Case Covid 19</title>

...
while($row = mysqli_fetch_array($negara)){
	...
	$query = mysqli_query($koneksi,"select new_dead from tb_allcase where id_negara ='".$row['id_negara']."'");
	$row = $query->fetch_array();
	$total_case[] = $row['new_dead'];
}
?>
<!doctype html>
<html>
...
<head>
	<title>Pie Chart Total New Dead Covid 19</title>
...
<body>
	...
	<h1>Total New Death 10 Negara</h1>

...
while($row = mysqli_fetch_array($negara)){
	...
	$query = mysqli_query($koneksi,"select active_case from tb_allcase where id_negara ='".$row['id_negara']."'");
	$row = $query->fetch_array();
	$total_case[] = $row['active_case'];
}
?>
<!doctype html>
<html>
...
<head>
	<title>Pie Chart Active Case Covid 19</title>
